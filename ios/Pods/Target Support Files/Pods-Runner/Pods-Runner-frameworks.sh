...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DirectCheckout/DirectCheckout.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/facebook_app_events/facebook_app_events.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/juno_direct_checkout/juno_direct_checkout.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/pusher/pusher.framework"
