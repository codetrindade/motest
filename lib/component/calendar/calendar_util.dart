...
class CalendarUtil {
  static final DateFormat _monthFormat = new DateFormat("MMM yyyy");
  ...
  static final DateFormat _apiDayFormat = new DateFormat("dd-MM-yyyy");
  ...
  static List<DateTime> daysInMonth(DateTime month) {
    ...
    var last = CalendarUtil.lastDayOfMonth(month);
